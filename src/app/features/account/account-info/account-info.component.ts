...
export class AccountInfoComponent implements OnInit{
  ...
  constructor(private router : ActivatedRoute,
              ...
              private calculator: ExpenseIncomeTotalService){
  ...
  ngOnInit(): void {
    ...
    this.transactions$ = this.refreshSubject.pipe(switchMap(() => this.transactionService.getTransactionsByAccountId(this.id, this.days)));
  ...
  addTransaction() {
    ...
    modalRef.result
      .then(() => this.refreshSubject.next(undefined));
