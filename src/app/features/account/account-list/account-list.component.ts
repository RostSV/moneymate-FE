...
export class AccountListComponent {
  ...
  constructor(accountService: AccountApiService,
              private modalService: NgbModal,
              private router: Router) {
    this.accounts$ = this.refreshSubject.pipe(switchMap(() => accountService.getAccounts()));
  }

  addAccount() {
    this.modalService.open(CreateAccountFormComponent, { centered: true })
